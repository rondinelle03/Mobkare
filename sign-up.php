						...
						<div class="w-lg-600px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
								...
								<div class="mb-10 text-center">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Crie uma conta</h1>
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-400 fw-bold fs-4">Já possuí uma conta?
									<a href="#" class="link-primary fw-bolder">clique aqui.</a></div>
									<!--end::Link-->
								</div>
								<!--end::Heading-->
								<!--begin::Action-->
								<button type="button" class="btn btn-light-primary fw-bolder w-100 mb-10">
								<img alt="Logo" src="assets/media/svg/brand-logos/google-icon.svg" class="h-20px me-3" />Acesse pelo Google</button>
								<!--end::Action-->
								<!--begin::Separator-->
								...
								<div class="row fv-row mb-7">
									<!--begin::Col-->
									<div class="col-xl-6">
										<label class="form-label fw-bolder text-dark fs-6">Seu nome</label>
										<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="first-name" autocomplete="off" />
									</div>
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-xl-6">
										<label class="form-label fw-bolder text-dark fs-6">Seu e-mail</label>
								...
								<div class="fv-row mb-10">
									<label class="form-check form-check-custom form-check-solid form-check-inline">
										...
										<span class="form-check-label fw-bold text-gray-700 fs-6">Eu aceito
										<a href="#" class="ms-1 link-primary">Termo e condições</a>.</span>
									</label>
								</div>
								<!--end::Input group-->
								<!--begin::Actions-->
