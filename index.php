						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Adicionar Novo</a>
									<!--end::Primary button-->
								</div>
								<!--end::Actions-->
							</div>
									...
									<div class="col-xl-4">
										...
										<div class="card card-xl-stretch">
											...
											<div class="card-header border-0 bg-danger py-5">
												<h3 class="card-title fw-bolder text-white">Números do sistema</h3>
												...
												<div class="card-p mt-n20 position-relative">
													...
													<div class="row g-0">
														...
														<div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
															...
															<span class="dados-sistema svg-icon svg-icon-3x svg-icon-warning d-block my-2">
																221
															</span>
															<!--end::Svg Icon-->
															<a href="#" class="text-warning fw-bold fs-6">Alunos</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
															<!--begin::Svg Icon | path: icons/duotune/finance/fin006.svg-->
															<span class="dados-sistema svg-icon svg-icon-3x svg-icon-primary d-block my-2">
																122
															</span>
															<!--end::Svg Icon-->
															<a href="#" class="text-primary fw-bold fs-6">Usuários</a>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
													...
													<div class="row g-0">
														...
														<div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
															...
															<span class="dados-sistema svg-icon svg-icon-3x svg-icon-danger d-block my-2">
																1892
															</span>
															<!--end::Svg Icon-->
															<a href="#" class="text-danger fw-bold fs-6 mt-2">Rotinas últimos 7 dias</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
